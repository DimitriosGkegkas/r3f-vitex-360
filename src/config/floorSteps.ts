...
export const floors: Record<string, Floor> = {
  'raw-materials': {
    ...
    steps: [
      ...
      // },
      {
        ...
        description: 'Εδώ βρίσκονται τα 11 σιλό που αποθηκεύουν τις πρώτες ύλες με ασφάλεια και οργάνωση. Τα χαρακτηριστικά χρώματα του Χρωμοπύργου ξεχωρίζουν και σε αυτό το σημείο, ως σήμα κατατεθέν του εργοστασίου.',
        stepName: 'Πέμπτο',
        environmentId: 'raw-materials-env_5_5'
      },
      // {
  ...
  'quantities': {
    ...
    steps: [
      {
        id: 'step_3_1',
        title: 'Επίπεδο προσθήκης προζυγισμένων προσθέτων',
        description: 'Σε αυτό το επίπεδο προστίθενται τα προζυγισμένα πρόσθετα, δίνοντας στο μίγμα τα ειδικά χαρακτηριστικά που το κάνουν μοναδικό και υψηλής ποιότητας.',
        stepName: 'Πρώτο',
      ...
      // },
      {
        ...
        description: 'Εδώ γίνεται η ρήψη των προζυγισμένων πρόσθετων προς ανάδευση',
        stepName: 'Δεύτερο',
        environmentId: 'quantities-env_3_2'
      },
      // {
  ...
  'packaging': {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Στο ισόγειο στεγάζονται το control room, το meeting room, το εργαστήριο ποιοτικού ελέγχου, το γραφείο ΙΤ, το γραφείο κίνησης και οι χώροι πινάκων και οι χώροι Η/Μ πινάκων, αποτελώντας το κέντρο ελέγχου και οργάνωσης του εργοστασίου.',
        stepName: 'Πρώτο',
        environmentId: 'packaging-env_0_1'
      },
      // {
